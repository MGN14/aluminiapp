        ...
        <Card>
          <CardContent className="py-12 flex flex-col items-center text-center gap-4">
            ...
            <div className="space-y-1.5 max-w-md">
              ...
              <p className="text-sm text-muted-foreground">
                Empezá configurando tus productos terminados (sistema + color + componentes por
                m²). Después armás cotizaciones en 2 minutos y las enviás directo al cliente.
              </p>
            </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell className="text-right tabular-nums font-medium">
                            {formatCurrency(
                              q.apply_iva ? Number(q.total_with_iva) : Number(q.total),
                            )}
                            {q.apply_iva && (
                              <span className="text-[9px] text-muted-foreground ml-1">c/IVA</span>
                            )}
                          </TableCell>
                          <TableCell onClick={(e) => e.stopPropagation()}>
                            <Button variant="ghost" size="sm" onClick={() => setDetailId(q.id)}>
