...
return [
  ...
  },
  {
    ...
    hint: `${stockLabel} − físico real, NETO (suma con signo). Positivo = ${stockLabel} dice más de lo que hay físicamente.`,
    icon: ArrowLeftRight,
    format: fmt,
  ...
  },
  {
    ...
    hint: `Plata en riesgo: (${stockLabel} − físico real) × costo unitario, sumado con signo — la brecha neta entre lo declarado y lo que hay.`,
    icon: Wallet,
    format: fmtCurrency,
