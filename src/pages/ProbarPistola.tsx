...
import { Check, RadioTower, ScanLine } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Apuntá la pistola a un QR <strong>de esta pantalla</strong>. Si la lectura aparece abajo, lee y “teclea” en la app — sin imprimir nada.</p>
          </div>
        </div>
