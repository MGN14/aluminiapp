      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Step 1 */}
            <div className="bg-card rounded-xl p-8 border-2 border-success/30 shadow-md hover:shadow-lg hover:border-success/60 transition-all animate-slide-up">
              <div className="w-14 h-14 rounded-xl bg-success flex items-center justify-center mb-6">
                <Upload className="w-7 h-7 text-white" />
              </div>
              <div className="text-sm font-bold text-success mb-2 uppercase tracking-wide">Paso 1</div>
            ...
            {/* Step 2 */}
            <div className="bg-card rounded-xl p-8 border-2 border-success/30 shadow-md hover:shadow-lg hover:border-success/60 transition-all animate-slide-up" style={{
            animationDelay: '0.1s'
          }}>
              <div className="w-14 h-14 rounded-xl bg-success flex items-center justify-center mb-6">
                <TableProperties className="w-7 h-7 text-white" />
              </div>
              <div className="text-sm font-bold text-success mb-2 uppercase tracking-wide">Paso 2</div>
              <h3 className="text-xl font-semibold text-foreground mb-3">
                Revisa y categoriza
              </h3>
              <p className="text-muted-foreground">
            ...
            animationDelay: '0.2s'
              ...
              <div className="text-sm font-bold text-success mb-2 uppercase tracking-wide">Paso 3</div>
              <h3 className="text-xl font-semibold text-foreground mb-3">
                Exporta a Excel
              </h3>
              <p className="text-muted-foreground">
