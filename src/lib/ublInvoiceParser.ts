 ...
 *
 * KEEP IN SYNC: este archivo es copia literal de
 * supabase/functions/_shared/ublInvoiceParser.ts (el canónico — la edge
 * function receive-purchase-invoice usa ese). Si tocás uno, tocá el otro.
 */
