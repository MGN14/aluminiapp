          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route
                ...
                element={<RequireModule moduleKey="rentabilidad"><Rentabilidad /></RequireModule>}
              />
              <Route
                path="/reportes/punto-equilibrio"
                element={<RequireModule moduleKey="punto_equilibrio"><PuntoEquilibrio /></RequireModule>}
              />
              <Route
