...
const ComprobantesIngreso = lazy(() => import("./pages/ComprobantesIngreso"));
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              />
              <Route
                path="/comprobantes-ingreso"
                element={<RequireModule moduleKey="caja_menor"><ComprobantesIngreso /></RequireModule>}
              />
              <Route
                path="/informe-banco"
