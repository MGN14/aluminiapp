...
export const MODULE_KEYS = [
  ...
  { key: 'escaneo', label: 'Escaneo de bodega (pistola QR)', group: 'movimientos' as ModuleGroup, description: 'Estaciones de despacho y conteo con la pistola QR. Escanea sin ver precios ni el resto del inventario.' },
  ...
  { key: 'rentabilidad', label: 'Rentabilidad', group: 'reportes' as ModuleGroup, description: 'Margen real por producto y por cliente' },
  { key: 'punto_equilibrio', label: 'Punto de equilibrio', group: 'reportes' as ModuleGroup, description: 'Margen de contribución y cuánto vender para no perder' },
  ...
  { key: 'flujo_caja', label: 'Flujo de caja', group: 'reportes' as ModuleGroup, description: 'Entradas y salidas de dinero' },
